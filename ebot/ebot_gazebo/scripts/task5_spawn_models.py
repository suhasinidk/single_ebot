...
def inventory_items_pose():
    i_position = [
     [
      26.7, -2.984], [26.78, -3.21], [26.55, -3.23], [26.395, -3.45], [26.29, -3.613], [26.33, -3.88]]
    ...
    i_pose3 = [i_position[2][0], i_position[2][1], 1.17, 0.0, 0.0, 0.0]
    i_pose4 = [i_position[3][0], i_position[3][1], 1.17, 0.0, 0.0, 0.0]
    i_pose5 = [i_position[4][0], i_position[4][1], 1.17, 0.0, 0.0, 0.0]
    i_pose6 = [i_position[5][0], i_position[5][1], 1.17, 0.0, 0.0, 0.0]
    return (
     i_pose1, i_pose2, i_pose3, i_pose4, i_pose5, i_pose6)
